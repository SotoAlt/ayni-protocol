 ...
 *
 * Usage:
 *   Terminal 1: cd hackathon/server && npm run dev
 *   Terminal 2: cd frontend && npm run dev
 *   Terminal 3: cd hackathon/demo && npx tsx live-demo.ts
 */
...
async function main() {
  ...
  try {
    ...
    console.error(`   Make sure the server is running: cd hackathon/server && npm run dev`);
