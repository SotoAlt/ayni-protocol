...
export const GLYPHS: Record<string, GlyphDefinition> = {
  ...
  E01: {
    ...
    visual: { glyphs: ['waiting', 'x'], category: 'symbol' },
  },
  A01: {
    ...
    visual: { glyphs: ['running', 'lightning'], category: 'symbol' },
  },
  ...
  Q02: {
    ...
    visual: { glyphs: ['asking', 'eye'], category: 'symbol' },
  },
  Q03: {
    meaning: 'Query API',
    pose: 'geometric',
    ...
    visual: { glyphs: ['asking', 'server'], category: 'symbol' },
  },
  R02: {
  ...
  E02: {
    ...
    visual: { glyphs: ['waiting', 'clock', 'x'], category: 'creature' },
  },
  E03: {
    ...
    visual: { glyphs: ['waiting', 'lock', 'x'], category: 'symbol' },
  },
  A02: {
    ...
    visual: { glyphs: ['giving', 'robot'], category: 'machine' },
  },
  A03: {
    meaning: 'Update Data',
    pose: 'machine',
    ...
    visual: { glyphs: ['running', 'database', 'arrow'], category: 'machine' },
  },
